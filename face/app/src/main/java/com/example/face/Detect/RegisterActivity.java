...
//                    param.putExtra("message",msg);
//                    setResult(2,param);
//
//                    LayoutInflater inflater = LayoutInflater.from(RegisterActivity.this);
//                    View layout = inflater.inflate(R.layout.login_register, null);
//                    mEditText = (EditText) layout.findViewById(R.id.regist_name);
//                    mEditText.setFilters(new InputFilter[]{new InputFilter.LengthFilter(16)});
//                    mExtImageView = (ExtImageView) layout.findViewById(R.id.regist_imageview);
//                    mExtImageView.setImageBitmap((Bitmap) msg.obj);
//                    mButtonRegister = (Button) layout.findViewById(R.id.btn_register);
//                    final Bitmap face = (Bitmap) msg.obj;
